...
export const modelEndpoints: Endpoints[] = [
  {
    ...
    url: 'identification',
    method: 'POST',
    description: 'Submit images to identify plant species and receive possible matches with information.',
    // icon: 'dashboard',
    isActive: true,
    source: 'plant.id',
  },
  {
    ...
    method: 'POST',
    description: 'Upload images to assess plant health, detect diseases, pests, or other issues.',
    // icon: 'health',
    isActive: true,
    source: 'plant.id',
  },
  ...
  },
  {
    ...
    url: '/predict/pest',
    method: 'POST',
    description: 'Submit crop images to identify pest infestations and type of pest present.',
    isActive: true,
    source: 'Development Team',
  },
  {
